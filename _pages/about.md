...
<!-- <style>
/* About page: enlarge main title, section headings, and body text */
.page__title { font-size: 2.4rem; }
.page__content h2 { font-size: 1.6rem; padding-bottom: 0.35em; }
.page__content p, .page__content li, .author__bio { font-size: 1.35rem; }
.author__name { font-size: 1.5rem; }

@media (min-width: 600px) {
  .page__title { font-size: 3rem; }
  .page__content h2 { font-size: 1.85rem; }
}
</style> -->
